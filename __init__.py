...
@app.get("/departments", tags=["Departements Methods"])
...
@app.get("/departments/{name}/towns", tags=["Departements Methods"])
...
@app.get("/departments/{name}/districts", tags=["Departements Methods"])
...
@app.get("/departments/{name}/neighborhoods", tags=["Departements Methods"])
...
@app.get("/towns", tags=["Towns Methods"])
...
@app.get("/towns/{town_name}/districts", tags=["Towns Methods"])
...
@app.get("/towns/{town_name}/neighborhoods", tags=["Towns Methods"])
...
@app.get("/districts", tags=["Districts Methods"])
...
@app.get("/districts/{district_name}/neighborhoods", tags=["Districts Methods"])
...
@app.get("/neighborhoods", tags=["Neighborhoods Methods"])
